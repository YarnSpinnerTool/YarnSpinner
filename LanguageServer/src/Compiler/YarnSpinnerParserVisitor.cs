...
public interface IYarnSpinnerParserVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitDeclared_variable([NotNull] YarnSpinnerParser.Declared_variableContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitFunction_parameter([NotNull] YarnSpinnerParser.Function_parameterContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="YarnSpinnerParser.function_name"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitFunction_name([NotNull] YarnSpinnerParser.Function_nameContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitCommand_parameter([NotNull] YarnSpinnerParser.Command_parameterContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="YarnSpinnerParser.command_name_rule"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitCommand_name_rule([NotNull] YarnSpinnerParser.Command_name_ruleContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitJump_destination([NotNull] YarnSpinnerParser.Jump_destinationContext context);
}
} // namespace Yarn.Compiler
