\hypertarget{a00124}{\section{Yarn.\-Program Class Reference}
\label{a00124}\index{Yarn.\-Program@{Yarn.\-Program}}
}
...
\begin{DoxyCompactItemize}
\item 
Dictionary$<$ string, string $>$ \hyperlink{a00124_a91518fda7e41bf573f66c6946dd3b4cb}{strings} = new Dictionary$<$string, string$>$ ()
\item 
Dictionary$<$ string, \hyperlink{a00103}{Line\-Info} $>$ \hyperlink{a00124_a0d4da395947767b4a1eaaff8a9842adc}{line\-Info} = new Dictionary$<$string, \hyperlink{a00103}{Line\-Info}$>$()
\item 
Dictionary$<$ string, \hyperlink{a00029_da/de0/a00317}{Node} $>$ \hyperlink{a00124_a3f4928a577c88263ad016be259b175c4}{nodes} = new Dictionary$<$string, \hyperlink{a00029_da/de0/a00317}{Node}$>$()
\end{DoxyCompactItemize}
\subsection*{Properties}
\begin{DoxyCompactItemize}
\item 
Dictionary$<$ string, string $>$ \hyperlink{a00124_aa8fedbfceaf931d1da3f600eaab6ae87}{untagged\-Strings}\hspace{0.3cm}{\ttfamily  \mbox{[}get\mbox{]}}
\end{DoxyCompactItemize}
\subsection*{Private Attributes}
\begin{DoxyCompactItemize}
\item 
int \hyperlink{a00124_a8ef1d10094ef00311aade6715ba78ec7}{string\-Count} = 0
\end{DoxyCompactItemize}
...
\hypertarget{a00124_a2f5bb468ce53eb7bbe647e3c11ddbb61}{\index{Yarn\-::\-Program@{Yarn\-::\-Program}!Dump\-Code@{Dump\-Code}}
...
)}}\label{a00124_a2f5bb468ce53eb7bbe647e3c11ddbb61}
...
135         \}
\end{DoxyCode}
\hypertarget{a00124_a14737b93594c4aab25c59cb0a3c918f7}{\index{Yarn\-::\-Program@{Yarn\-::\-Program}!Get\-String@{Get\-String}}
...
\item[{string}]{key}
\end{DoxyParamCaption}
)}}\label{a00124_a14737b93594c4aab25c59cb0a3c918f7}
...
86         \}
\end{DoxyCode}
\hypertarget{a00124_aad8029f37832ff1985fad6a31e51afd8}{\index{Yarn\-::\-Program@{Yarn\-::\-Program}!Get\-Text\-For\-Node@{Get\-Text\-For\-Node}}
...
\end{DoxyParamCaption}
)}}\label{a00124_aad8029f37832ff1985fad6a31e51afd8}

\begin{DoxyCode}
137                                                       \{
138             \textcolor{keywordflow}{return} this.GetString (\hyperlink{a00124_a3f4928a577c88263ad016be259b175c4}{nodes} [nodeName].sourceTextStringID);
139         \}
\end{DoxyCode}
\hypertarget{a00124_afd3385ca1f7589b3b9dae3646e4fee84}{\index{Yarn\-::\-Program@{Yarn\-::\-Program}!Include@{Include}}
...
\end{DoxyParamCaption}
)}}\label{a00124_afd3385ca1f7589b3b9dae3646e4fee84}

\begin{DoxyCode}
142         \{
143             \textcolor{keywordflow}{foreach} (var otherNodeName \textcolor{keywordflow}{in} otherProgram.nodes) \{
144 
145                 \textcolor{keywordflow}{if} (\hyperlink{a00124_a3f4928a577c88263ad016be259b175c4}{nodes}.ContainsKey(otherNodeName.Key)) \{
...
147                 \}
148 
149                 \hyperlink{a00124_a3f4928a577c88263ad016be259b175c4}{nodes} [otherNodeName.Key] = otherNodeName.Value;
150             \}
151 
152             \textcolor{keywordflow}{foreach} (var otherString \textcolor{keywordflow}{in} otherProgram.strings) \{
153 
154                 \textcolor{keywordflow}{if} (\hyperlink{a00124_a3f4928a577c88263ad016be259b175c4}{nodes}.ContainsKey(otherString.Key)) \{
...
156                 \}
157 
158                 \hyperlink{a00124_a91518fda7e41bf573f66c6946dd3b4cb}{strings} [otherString.Key] = otherString.Value;
159             \}
160         \}
\end{DoxyCode}
\hypertarget{a00124_a977d1ed02e3f6f39d30dfea1663e7927}{\index{Yarn\-::\-Program@{Yarn\-::\-Program}!Load\-Strings@{Load\-Strings}}
...
\end{DoxyParamCaption}
)}}\label{a00124_a977d1ed02e3f6f39d30dfea1663e7927}

\begin{DoxyCode}
56                                                                       \{
57             \textcolor{keywordflow}{foreach} (var entry \textcolor{keywordflow}{in} newStrings) \{
58                 \hyperlink{a00124_a91518fda7e41bf573f66c6946dd3b4cb}{strings} [entry.Key] = entry.Value;
59             \}
60         \}
\end{DoxyCode}
\hypertarget{a00124_a9baf491479375aa8c3aa2b0c31cf0932}{\index{Yarn\-::\-Program@{Yarn\-::\-Program}!Register\-String@{Register\-String}}
...
\end{DoxyParamCaption}
)}}\label{a00124_a9baf491479375aa8c3aa2b0c31cf0932}
...
67                 key = string.Format (\textcolor{stringliteral}{"\{0\}-\{1\}"}, nodeName, \hyperlink{a00124_a8ef1d10094ef00311aade6715ba78ec7}{stringCount}++);
...
\hypertarget{a00124_a0d4da395947767b4a1eaaff8a9842adc}{\index{Yarn\-::\-Program@{Yarn\-::\-Program}!line\-Info@{line\-Info}}
...
\hypertarget{a00124_a3f4928a577c88263ad016be259b175c4}{\index{Yarn\-::\-Program@{Yarn\-::\-Program}!nodes@{nodes}}
...
\hypertarget{a00124_a8ef1d10094ef00311aade6715ba78ec7}{\index{Yarn\-::\-Program@{Yarn\-::\-Program}!string\-Count@{string\-Count}}
...
\hypertarget{a00124_a91518fda7e41bf573f66c6946dd3b4cb}{\index{Yarn\-::\-Program@{Yarn\-::\-Program}!strings@{strings}}
...
\hypertarget{a00124_aa8fedbfceaf931d1da3f600eaab6ae87}{\index{Yarn\-::\-Program@{Yarn\-::\-Program}!untagged\-Strings@{untagged\-Strings}}
