...
\item When the file is returned from translators, we then use \hyperlink{a00051}{Yarn} Spinner's Dialogue\-Runner inside Unity to set String Groups for the required language.
\end{DoxyEnumerate}
...
\item Originally, \hyperlink{a00051}{Yarn} Spinner used .json format. The \hyperlink{a00051}{Yarn} Spinner Console can convert this json format to the new improved text format\-: {\ttfamily Yarn\-Spinner\-Console.\-exe convert -\/-\/yarn Ship.\-json}
