\hypertarget{a00057}{\section{Yarn.\-Parser.\-If\-Statement Class Reference}
\label{a00057}\index{Yarn.\-Parser.\-If\-Statement@{Yarn.\-Parser.\-If\-Statement}}
}
...
\hypertarget{a00057_ae534078389e8663edf7660403acf3cbc}{\index{Yarn\-::\-Parser\-::\-If\-Statement@{Yarn\-::\-Parser\-::\-If\-Statement}!If\-Statement@{If\-Statement}}
...
)\hspace{0.3cm}{\ttfamily [package]}}}\label{a00057_ae534078389e8663edf7660403acf3cbc}
...
619                     \textcolor{keywordflow}{while} (p.NextSymbolsAre(\hyperlink{a00040_a301aa7c866593a5b625a8fc158bbeace}{TokenType}.BeginCommand, 
      \hyperlink{a00040_a301aa7c866593a5b625a8fc158bbeace}{TokenType}.EndIf) == \textcolor{keyword}{false}) \{
...
627                     \textcolor{keywordflow}{while} (p.NextSymbolIs(\hyperlink{a00040_a301aa7c866593a5b625a8fc158bbeace}{TokenType}.Dedent)) \{
...
\hypertarget{a00057_afd6b96e1a27872701c4e6832f17fc3ce}{\index{Yarn\-::\-Parser\-::\-If\-Statement@{Yarn\-::\-Parser\-::\-If\-Statement}!Can\-Parse@{Can\-Parse}}
...
\item[{{\bf Parser}}]{p}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [package]}}}\label{a00057_afd6b96e1a27872701c4e6832f17fc3ce}
...
527             \}
\end{DoxyCode}
\hypertarget{a00077_a580e520a29444fc23ac3660cbe514a09}{\index{Yarn\-::\-Parser\-::\-If\-Statement@{Yarn\-::\-Parser\-::\-If\-Statement}!Node\-Parent@{Node\-Parent}}
...
128             \}
\end{DoxyCode}
\hypertarget{a00057_a5494c1daef8e0f3ac3ab68f91db4f332}{\index{Yarn\-::\-Parser\-::\-If\-Statement@{Yarn\-::\-Parser\-::\-If\-Statement}!Print\-Tree@{Print\-Tree}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [package]}, {\ttfamily [virtual]}}}\label{a00057_a5494c1daef8e0f3ac3ab68f91db4f332}
...
643                 \textcolor{keywordflow}{foreach} (var clause \textcolor{keywordflow}{in} \hyperlink{a00057_a679b1a21582c78ed06df36bccc9c3cbc}{clauses}) \{
644                     \textcolor{keywordflow}{if} (first) \{
645                         sb.Append (\hyperlink{a00078_aa8fa36b46de12a1c561d77b99c4b9ae3}{Tab} (indentLevel, \textcolor{stringliteral}{"If:"}));
646                         first = \textcolor{keyword}{false};
647                     \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (clause.expression != null) \{
648                         sb.Append (\hyperlink{a00078_aa8fa36b46de12a1c561d77b99c4b9ae3}{Tab} (indentLevel, \textcolor{stringliteral}{"Else If:"}));
649                     \} \textcolor{keywordflow}{else} \{
650                         sb.Append (\hyperlink{a00078_aa8fa36b46de12a1c561d77b99c4b9ae3}{Tab} (indentLevel, \textcolor{stringliteral}{"Else:"}));
651                     \}
...
656             \}
\end{DoxyCode}
\hypertarget{a00077_a18c67cb16090d0889bb9d6c8c6c565f8}{\index{Yarn\-::\-Parser\-::\-If\-Statement@{Yarn\-::\-Parser\-::\-If\-Statement}!To\-String@{To\-String}}
...
\hypertarget{a00057_a679b1a21582c78ed06df36bccc9c3cbc}{\index{Yarn\-::\-Parser\-::\-If\-Statement@{Yarn\-::\-Parser\-::\-If\-Statement}!clauses@{clauses}}
\index{clauses@{clauses}!Yarn::Parser::IfStatement@{Yarn\-::\-Parser\-::\-If\-Statement}}
\subsubsection[{clauses}]{\setlength{\rightskip}{0pt plus 5cm}List$<${\bf Clause}$>$ Yarn.\-Parser.\-If\-Statement.\-clauses = new List$<${\bf Clause}$>$()\hspace{0.3cm}{\ttfamily [package]}}}\label{a00057_a679b1a21582c78ed06df36bccc9c3cbc}
