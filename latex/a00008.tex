So this is a W\-I\-P parser/lexer for \hyperlink{a00347}{Yarn\-Spinner} written in A\-N\-T\-L\-R with that plan being that it will eventually replace the hand made one currently in use.
...
Then copy these into the \hyperlink{a00347}{Yarn\-Spinner} project.
...
As it currently stands \hyperlink{a00347}{Yarn\-Spinner} has three different ways of controlling the game and dialogue.
...
As it currently stands the allowed headers are {\ttfamily title} (required) and {\ttfamily tags}, {\ttfamily position}, and {\ttfamily color\-I\-D} all being optional. Because of a combination of my hesitance to in line code, and A\-N\-T\-L\-R4 syntax there is nothing stopping you putting as many of the optional headers in as you want. When it comes time to compile the \hyperlink{a00050}{Yarn} files the compiler will complain about this but the parser will not.
