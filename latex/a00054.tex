\hypertarget{a00054}{\section{Yarn.\-Parser.\-Expression Class Reference}
\label{a00054}\index{Yarn.\-Parser.\-Expression@{Yarn.\-Parser.\-Expression}}
}
...
\begin{center}
\leavevmode
\includegraphics[width=214pt]{a00285}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{a00286}
\end{center}
\end{figure}
...
\begin{DoxyCompactItemize}
\item 
enum \hyperlink{a00054_aceddb5496ccffe668bced2d131e4bf86}{Type} \{ \hyperlink{a00054_aceddb5496ccffe668bced2d131e4bf86a689202409e48743b914713f96d93947c}{Type.\-Value}, 
\hyperlink{a00054_aceddb5496ccffe668bced2d131e4bf86affb017548928ab2305e7c55cb67c04ca}{Type.\-Function\-Call}
 \}
\end{DoxyCompactItemize}
...
\hypertarget{a00054_aceddb5496ccffe668bced2d131e4bf86}{\index{Yarn\-::\-Parser\-::\-Expression@{Yarn\-::\-Parser\-::\-Expression}!Type@{Type}}
...
\begin{DoxyCode}
737                                \{
738                 \hyperlink{a00054_aceddb5496ccffe668bced2d131e4bf86a689202409e48743b914713f96d93947c}{Value},
739                 \hyperlink{a00054_aceddb5496ccffe668bced2d131e4bf86affb017548928ab2305e7c55cb67c04ca}{FunctionCall}
740             \}
\end{DoxyCode}


\subsection{Constructor \& Destructor Documentation}
\hypertarget{a00054_a91f0536300ebb39eaf9b7526c7e97364}{\index{Yarn\-::\-Parser\-::\-Expression@{Yarn\-::\-Parser\-::\-Expression}!Expression@{Expression}}
...
)\hspace{0.3cm}{\ttfamily [package]}}}\label{a00054_a91f0536300ebb39eaf9b7526c7e97364}

\begin{DoxyCode}
749                                                                    : base(\hyperlink{a00077_af313a82103fcc2ff5a177dbb06b92f7b}{parent}, null) \{
750                 this.type = Type.Value;
751                 this.value = \hyperlink{a00054_a569e516782891544c334ff8131b23108}{value};
752             \}
\end{DoxyCode}
\hypertarget{a00054_ac2a8b8fd554b8006b5e2f1d1ca3cf93e}{\index{Yarn\-::\-Parser\-::\-Expression@{Yarn\-::\-Parser\-::\-Expression}!Expression@{Expression}}
\index{Expression@{Expression}!Yarn::Parser::Expression@{Yarn\-::\-Parser\-::\-Expression}}
\subsubsection[{Expression}]{\setlength{\rightskip}{0pt plus 5cm}Yarn.\-Parser.\-Expression.\-Expression (
\begin{DoxyParamCaption}
\item[{{\bf Parse\-Node}}]{parent, }
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [package]}}}\label{a00054_ac2a8b8fd554b8006b5e2f1d1ca3cf93e}

\begin{DoxyCode}
754                                                                                                       : 
      base(\hyperlink{a00077_af313a82103fcc2ff5a177dbb06b92f7b}{parent}, null) \{
755                 \hyperlink{a00054_ad55c92df835006328bc2a79a8f91efb9}{type} = Type.FunctionCall;
756                 this.function = \textcolor{keyword}{function};
757                 this.parameters = \hyperlink{a00054_a7b21380bead8ae08b2cfc6594edab32c}{parameters};
758             \}
\end{DoxyCode}


\subsection{Member Function Documentation}
\hypertarget{a00077_a580e520a29444fc23ac3660cbe514a09}{\index{Yarn\-::\-Parser\-::\-Expression@{Yarn\-::\-Parser\-::\-Expression}!Node\-Parent@{Node\-Parent}}
...
128             \}
\end{DoxyCode}
\hypertarget{a00054_a686da57aaf67d50d2832f9ee0028a979}{\index{Yarn\-::\-Parser\-::\-Expression@{Yarn\-::\-Parser\-::\-Expression}!Parse@{Parse}}
...
\item[{{\bf Parser}}]{p}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [package]}}}\label{a00054_a686da57aaf67d50d2832f9ee0028a979}
...
871                         \textcolor{keywordflow}{if} (nextToken.type == \hyperlink{a00040_a301aa7c866593a5b625a8fc158bbeace}{TokenType}.EqualToOrAssign) \{
...
880                         \textcolor{keywordflow}{while} (\hyperlink{a00054_a5004a8eaa00b2b55856ecb4f339033fb}{ShouldApplyPrecedence}(nextToken.type, operatorStack)) \{
881                             var o = operatorStack.Pop();
882                             \_expressionRPN.Enqueue(o);
883                         \}
884                         operatorStack.Push(nextToken);
885 
886                     \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (nextToken.type == \hyperlink{a00040_a301aa7c866593a5b625a8fc158bbeace}{TokenType}.LeftParen) \{
887 
...
891                         
892                     \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (nextToken.type == \hyperlink{a00040_a301aa7c866593a5b625a8fc158bbeace}{TokenType}.RightParen) \{
893 
...
1019             \}
\end{DoxyCode}
\hypertarget{a00054_a509ba6d93218203bae56a5a7a82e8261}{\index{Yarn\-::\-Parser\-::\-Expression@{Yarn\-::\-Parser\-::\-Expression}!Print\-Tree@{Print\-Tree}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [package]}, {\ttfamily [virtual]}}}\label{a00054_a509ba6d93218203bae56a5a7a82e8261}
...
1053                 \textcolor{keywordflow}{switch} (\hyperlink{a00054_ad55c92df835006328bc2a79a8f91efb9}{type}) \{
...
1057                     
1058                     \textcolor{keywordflow}{if} (\hyperlink{a00054_a7b21380bead8ae08b2cfc6594edab32c}{parameters}.Count == 0) \{
1059                         stringBuilder.Append(\hyperlink{a00078_aa8fa36b46de12a1c561d77b99c4b9ae3}{Tab}(indentLevel, \textcolor{stringliteral}{"Function call to "} + \textcolor{keyword}{function}.name + \textcolor{stringliteral}{"
       (no parameters)"}));
1060                     \} \textcolor{keywordflow}{else} \{
1061                         stringBuilder.Append(\hyperlink{a00078_aa8fa36b46de12a1c561d77b99c4b9ae3}{Tab}(indentLevel, \textcolor{stringliteral}{"Function call to "} + \textcolor{keyword}{function}.name + \textcolor{stringliteral}{" ("}
       +\hyperlink{a00054_a7b21380bead8ae08b2cfc6594edab32c}{parameters}.Count+\textcolor{stringliteral}{" parameters) \{"}));
1062                         \textcolor{keywordflow}{foreach} (var param \textcolor{keywordflow}{in} \hyperlink{a00054_a7b21380bead8ae08b2cfc6594edab32c}{parameters}) \{
1063                             stringBuilder.Append(param.PrintTree(indentLevel+1));
1064                         \}
1065                         stringBuilder.Append(\hyperlink{a00078_aa8fa36b46de12a1c561d77b99c4b9ae3}{Tab}(indentLevel, \textcolor{stringliteral}{"\}"}));
1066                     \}
...
1070                 \}
1071 
1072                 \textcolor{keywordflow}{return} \hyperlink{a00078_aa8fa36b46de12a1c561d77b99c4b9ae3}{Tab}(indentLevel, \textcolor{stringliteral}{"<error printing expression!>"});
1073             \}
\end{DoxyCode}
\hypertarget{a00054_a5004a8eaa00b2b55856ecb4f339033fb}{\index{Yarn\-::\-Parser\-::\-Expression@{Yarn\-::\-Parser\-::\-Expression}!Should\-Apply\-Precedence@{Should\-Apply\-Precedence}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}}\label{a00054_a5004a8eaa00b2b55856ecb4f339033fb}
...
1030                 \}
1031                 \hyperlink{a00040_a301aa7c866593a5b625a8fc158bbeace}{TokenType} o2 = operatorStack.Peek ().\hyperlink{a00054_ad55c92df835006328bc2a79a8f91efb9}{type};
1032 
...
1048             \}
\end{DoxyCode}
\hypertarget{a00077_a18c67cb16090d0889bb9d6c8c6c565f8}{\index{Yarn\-::\-Parser\-::\-Expression@{Yarn\-::\-Parser\-::\-Expression}!To\-String@{To\-String}}
...
\hypertarget{a00054_a9c1859ce5ad4c86ded8dd0d61da61320}{\index{Yarn\-::\-Parser\-::\-Expression@{Yarn\-::\-Parser\-::\-Expression}!function@{function}}
\index{function@{function}!Yarn::Parser::Expression@{Yarn\-::\-Parser\-::\-Expression}}
\subsubsection[{function}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Function\-Info} Yarn.\-Parser.\-Expression.\-function\hspace{0.3cm}{\ttfamily [package]}}}\label{a00054_a9c1859ce5ad4c86ded8dd0d61da61320}
\hypertarget{a00054_a7b21380bead8ae08b2cfc6594edab32c}{\index{Yarn\-::\-Parser\-::\-Expression@{Yarn\-::\-Parser\-::\-Expression}!parameters@{parameters}}
\index{parameters@{parameters}!Yarn::Parser::Expression@{Yarn\-::\-Parser\-::\-Expression}}
\subsubsection[{parameters}]{\setlength{\rightskip}{0pt plus 5cm}List$<${\bf Expression}$>$ Yarn.\-Parser.\-Expression.\-parameters\hspace{0.3cm}{\ttfamily [package]}}}\label{a00054_a7b21380bead8ae08b2cfc6594edab32c}
\hypertarget{a00054_ad55c92df835006328bc2a79a8f91efb9}{\index{Yarn\-::\-Parser\-::\-Expression@{Yarn\-::\-Parser\-::\-Expression}!type@{type}}
\index{type@{type}!Yarn::Parser::Expression@{Yarn\-::\-Parser\-::\-Expression}}
\subsubsection[{type}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Type} Yarn.\-Parser.\-Expression.\-type\hspace{0.3cm}{\ttfamily [package]}}}\label{a00054_ad55c92df835006328bc2a79a8f91efb9}
\hypertarget{a00054_a569e516782891544c334ff8131b23108}{\index{Yarn\-::\-Parser\-::\-Expression@{Yarn\-::\-Parser\-::\-Expression}!value@{value}}
\index{value@{value}!Yarn::Parser::Expression@{Yarn\-::\-Parser\-::\-Expression}}
\subsubsection[{value}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Value\-Node} Yarn.\-Parser.\-Expression.\-value\hspace{0.3cm}{\ttfamily [package]}}}\label{a00054_a569e516782891544c334ff8131b23108}
