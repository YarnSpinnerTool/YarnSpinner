\hypertarget{a00112}{\section{Yarn.\-Parser.\-If\-Statement Class Reference}
\label{a00112}\index{Yarn.\-Parser.\-If\-Statement@{Yarn.\-Parser.\-If\-Statement}}
}
...
\begin{center}
\leavevmode
\includegraphics[width=202pt]{a00669}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=256pt]{a00670}
\end{center}
\end{figure}
\subsection*{Classes}
\begin{DoxyCompactItemize}
\item 
struct \hyperlink{a00044}{Clause}
...
\hypertarget{a00112_ae534078389e8663edf7660403acf3cbc}{\index{Yarn\-::\-Parser\-::\-If\-Statement@{Yarn\-::\-Parser\-::\-If\-Statement}!If\-Statement@{If\-Statement}}
...
)\hspace{0.3cm}{\ttfamily [package]}}}\label{a00112_ae534078389e8663edf7660403acf3cbc}
...
631                     \textcolor{keywordflow}{while} (p.NextSymbolsAre(\hyperlink{a00045_a301aa7c866593a5b625a8fc158bbeace}{TokenType}.BeginCommand, 
      \hyperlink{a00045_a301aa7c866593a5b625a8fc158bbeace}{TokenType}.EndIf) == \textcolor{keyword}{false}) \{
...
639                     \textcolor{keywordflow}{while} (p.NextSymbolIs(\hyperlink{a00045_a301aa7c866593a5b625a8fc158bbeace}{TokenType}.Dedent)) \{
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{a00112_ae534078389e8663edf7660403acf3cbc_cgraph}
\end{center}
\end{figure}
...
\hypertarget{a00112_afd6b96e1a27872701c4e6832f17fc3ce}{\index{Yarn\-::\-Parser\-::\-If\-Statement@{Yarn\-::\-Parser\-::\-If\-Statement}!Can\-Parse@{Can\-Parse}}
...
\item[{{\bf Parser}}]{p}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [package]}}}\label{a00112_afd6b96e1a27872701c4e6832f17fc3ce}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{a00112_afd6b96e1a27872701c4e6832f17fc3ce_icgraph}
\end{center}
\end{figure}


\hypertarget{a00142_a580e520a29444fc23ac3660cbe514a09}{\index{Yarn\-::\-Parser\-::\-If\-Statement@{Yarn\-::\-Parser\-::\-If\-Statement}!Node\-Parent@{Node\-Parent}}
...
\hypertarget{a00112_a5494c1daef8e0f3ac3ab68f91db4f332}{\index{Yarn\-::\-Parser\-::\-If\-Statement@{Yarn\-::\-Parser\-::\-If\-Statement}!Print\-Tree@{Print\-Tree}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [package]}, {\ttfamily [virtual]}}}\label{a00112_a5494c1daef8e0f3ac3ab68f91db4f332}
...
655                 \textcolor{keywordflow}{foreach} (var clause \textcolor{keywordflow}{in} \hyperlink{a00112_a679b1a21582c78ed06df36bccc9c3cbc}{clauses}) \{
656                     \textcolor{keywordflow}{if} (first) \{
657                         sb.Append (\hyperlink{a00143_aa8fa36b46de12a1c561d77b99c4b9ae3}{Tab} (indentLevel, \textcolor{stringliteral}{"If:"}));
658                         first = \textcolor{keyword}{false};
659                     \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (clause.expression != null) \{
660                         sb.Append (\hyperlink{a00143_aa8fa36b46de12a1c561d77b99c4b9ae3}{Tab} (indentLevel, \textcolor{stringliteral}{"Else If:"}));
661                     \} \textcolor{keywordflow}{else} \{
662                         sb.Append (\hyperlink{a00143_aa8fa36b46de12a1c561d77b99c4b9ae3}{Tab} (indentLevel, \textcolor{stringliteral}{"Else:"}));
663                     \}
...
\begin{center}
\leavevmode
\includegraphics[width=330pt]{a00112_a5494c1daef8e0f3ac3ab68f91db4f332_cgraph}
\end{center}
\end{figure}


\hypertarget{a00142_a054f36c80d5eeacd569a8859f599af67}{\index{Yarn\-::\-Parser\-::\-If\-Statement@{Yarn\-::\-Parser\-::\-If\-Statement}!Tags\-To\-String@{Tags\-To\-String}}
...
\hypertarget{a00142_a18c67cb16090d0889bb9d6c8c6c565f8}{\index{Yarn\-::\-Parser\-::\-If\-Statement@{Yarn\-::\-Parser\-::\-If\-Statement}!To\-String@{To\-String}}
...
\hypertarget{a00112_a679b1a21582c78ed06df36bccc9c3cbc}{\index{Yarn\-::\-Parser\-::\-If\-Statement@{Yarn\-::\-Parser\-::\-If\-Statement}!clauses@{clauses}}
\index{clauses@{clauses}!Yarn::Parser::IfStatement@{Yarn\-::\-Parser\-::\-If\-Statement}}
\subsubsection[{clauses}]{\setlength{\rightskip}{0pt plus 5cm}List$<${\bf Clause}$>$ Yarn.\-Parser.\-If\-Statement.\-clauses = new List$<${\bf Clause}$>$()\hspace{0.3cm}{\ttfamily [package]}}}\label{a00112_a679b1a21582c78ed06df36bccc9c3cbc}
...
\hypertarget{a00142_a18b493382de0fde5b4299c1bd2250075}{\index{Yarn\-::\-Parser\-::\-If\-Statement@{Yarn\-::\-Parser\-::\-If\-Statement}!line\-Number@{line\-Number}}
...
\hypertarget{a00142_af313a82103fcc2ff5a177dbb06b92f7b}{\index{Yarn\-::\-Parser\-::\-If\-Statement@{Yarn\-::\-Parser\-::\-If\-Statement}!parent@{parent}}
...
\hypertarget{a00142_a58b3a15788fd2d4127d73619dc6d04ae}{\index{Yarn\-::\-Parser\-::\-If\-Statement@{Yarn\-::\-Parser\-::\-If\-Statement}!tags@{tags}}
