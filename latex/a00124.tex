\hypertarget{a00124}{\section{Yarn.\-Line\-Adder Class Reference}
\label{a00124}\index{Yarn.\-Line\-Adder@{Yarn.\-Line\-Adder}}
}
...
\begin{center}
\leavevmode
\includegraphics[width=174pt]{a00643}
\end{center}
\end{figure}
\subsection*{Static Package Functions}
\begin{DoxyCompactItemize}
\item 
static int \hyperlink{a00124_aa2b8af349e709b8a45d42af5146ca848}{Add\-Lines} (\hyperlink{a00041}{Add\-Labels\-Options} options)
\end{DoxyCompactItemize}
\subsection*{Static Private Member Functions}
\begin{DoxyCompactItemize}
\item 
static string \hyperlink{a00124_a91ad68b679bd3b0bd89fe92ea5068688}{Generate\-String} (List$<$ string $>$ existing\-Keys)
\end{DoxyCompactItemize}
\subsection*{Static Private Attributes}
\begin{DoxyCompactItemize}
\item 
static Random \hyperlink{a00124_ad887744b1b813fc081be814958742c37}{random} = new Random()
\end{DoxyCompactItemize}
...
\hypertarget{a00124_aa2b8af349e709b8a45d42af5146ca848}{\index{Yarn\-::\-Line\-Adder@{Yarn\-::\-Line\-Adder}!Add\-Lines@{Add\-Lines}}
...
)\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [package]}}}\label{a00124_aa2b8af349e709b8a45d42af5146ca848}
...
17 
18             \textcolor{keywordflow}{foreach} (var file \textcolor{keywordflow}{in} options.\hyperlink{a00042_aa93cbb1bc1d5328e0a417012621e92d2}{files})
19             \{
20 
21                 \hyperlink{a00050_ad7ebb46e7309ead8767383a672b3272f}{NodeFormat} fileFormat;
...
39 
40 
41                 \hyperlink{a00090}{Dialogue} d = YarnSpinnerConsole.CreateDialogueForUtilities();
42 
...
76 
77                 \hyperlink{a00133}{Loader.NodeInfo}[] nodeInfoList;
78 
...
87                 var lineInfo = \textcolor{keyword}{new} Dictionary<string, \hyperlink{a00133}{Loader.NodeInfo}>();
88 
...
123                     \textcolor{keywordflow}{if} (options.\hyperlink{a00041_ab6162338f9606a836f3101fe0e228249}{onlyUseTag} != null)
124                     \{
125                         \textcolor{keywordflow}{if} (nodeInfo.tagsList.FindIndex(i => i == options.
      \hyperlink{a00041_ab6162338f9606a836f3101fe0e228249}{onlyUseTag}) == -1)
126                         \{
...
139                     var newTag = \hyperlink{a00124_a91ad68b679bd3b0bd89fe92ea5068688}{GenerateString}(existingKeys);
140 
141                     \textcolor{comment}{// Remember that we've used this tag, to prevent it from being re-used}
142                     existingKeys.Add(newTag);
143 
144                     \textcolor{keywordflow}{if} (options.\hyperlink{a00042_ada4d83d1756918f362d55f6649b82b17}{verbose})
145                     \{
...
173                 \textcolor{keywordflow}{if} (options.\hyperlink{a00041_a5dc9d9db767738237e988f95fc0330f4}{dryRun})
174                 \{
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{a00124_aa2b8af349e709b8a45d42af5146ca848_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{a00124_aa2b8af349e709b8a45d42af5146ca848_icgraph}
\end{center}
\end{figure}


\hypertarget{a00124_a91ad68b679bd3b0bd89fe92ea5068688}{\index{Yarn\-::\-Line\-Adder@{Yarn\-::\-Line\-Adder}!Generate\-String@{Generate\-String}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}}\label{a00124_a91ad68b679bd3b0bd89fe92ea5068688}
...
\hypertarget{a00124_ad887744b1b813fc081be814958742c37}{\index{Yarn\-::\-Line\-Adder@{Yarn\-::\-Line\-Adder}!random@{random}}
...
\item 
Yarn\-Spinner\-Console/\hyperlink{a00302}{Line\-Adder.\-cs}\end{DoxyCompactItemize}
