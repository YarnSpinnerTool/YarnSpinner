\hypertarget{a00104}{\section{Yarn.\-Line\-Adder Class Reference}
\label{a00104}\index{Yarn.\-Line\-Adder@{Yarn.\-Line\-Adder}}
}
...
\begin{center}
\leavevmode
\includegraphics[width=174pt]{d9/d0f/a00644}
\end{center}
\end{figure}
...
\hypertarget{a00104_aa2b8af349e709b8a45d42af5146ca848}{\index{Yarn\-::\-Line\-Adder@{Yarn\-::\-Line\-Adder}!Add\-Lines@{Add\-Lines}}
...
)\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [package]}}}\label{a00104_aa2b8af349e709b8a45d42af5146ca848}
...
17 
18             \textcolor{keywordflow}{foreach} (var file \textcolor{keywordflow}{in} options.\hyperlink{a00022_aa93cbb1bc1d5328e0a417012621e92d2}{files})
19             \{
20 
21                 \hyperlink{a00031_ad7ebb46e7309ead8767383a672b3272f}{NodeFormat} fileFormat;
...
41 
42 
43                 \hyperlink{a00072}{Dialogue} d = YarnSpinnerConsole.CreateDialogueForUtilities();
44 
...
76 
77                 \hyperlink{a00114}{Loader.NodeInfo}[] nodeInfoList;
78 
...
87                 var lineInfo = \textcolor{keyword}{new} Dictionary<string, \hyperlink{a00114}{Loader.NodeInfo}>();
88 
...
123                     \textcolor{keywordflow}{if} (options.\hyperlink{a00019_ab6162338f9606a836f3101fe0e228249}{onlyUseTag} != null)
124                     \{
125                         \textcolor{keywordflow}{if} (nodeInfo.tagsList.FindIndex(i => i == options.
      \hyperlink{a00019_ab6162338f9606a836f3101fe0e228249}{onlyUseTag}) == -1)
126                         \{
...
139                     var newTag = \hyperlink{a00104_a91ad68b679bd3b0bd89fe92ea5068688}{GenerateString}(existingKeys);
140 
141                     \textcolor{comment}{// Remember that we've used this tag, to prevent it from being re-used}
142                     existingKeys.Add(newTag);
143 
144                     \textcolor{keywordflow}{if} (options.\hyperlink{a00022_ada4d83d1756918f362d55f6649b82b17}{verbose})
145                     \{
...
173                 \textcolor{keywordflow}{if} (options.\hyperlink{a00019_a5dc9d9db767738237e988f95fc0330f4}{dryRun})
174                 \{
...
207         \}
\end{DoxyCode}
\hypertarget{a00104_a91ad68b679bd3b0bd89fe92ea5068688}{\index{Yarn\-::\-Line\-Adder@{Yarn\-::\-Line\-Adder}!Generate\-String@{Generate\-String}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}}\label{a00104_a91ad68b679bd3b0bd89fe92ea5068688}
...
\hypertarget{a00104_ad887744b1b813fc081be814958742c37}{\index{Yarn\-::\-Line\-Adder@{Yarn\-::\-Line\-Adder}!random@{random}}
\index{random@{random}!Yarn::LineAdder@{Yarn\-::\-Line\-Adder}}
\subsubsection[{random}]{\setlength{\rightskip}{0pt plus 5cm}Random Yarn.\-Line\-Adder.\-random = new Random()\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}}\label{a00104_ad887744b1b813fc081be814958742c37}


The documentation for this class was generated from the following file\-:\begin{DoxyCompactItemize}
\item 
Yarn\-Spinner\-Console/\hyperlink{a00273}{Line\-Adder.\-cs}\end{DoxyCompactItemize}
