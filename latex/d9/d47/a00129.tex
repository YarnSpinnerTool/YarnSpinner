\hypertarget{a00129}{\section{Csv\-Helper.\-Reflection\-Helper Class Reference}
\label{a00129}\index{Csv\-Helper.\-Reflection\-Helper@{Csv\-Helper.\-Reflection\-Helper}}
}
...
\begin{center}
\leavevmode
\includegraphics[width=218pt]{d7/d93/a00397}
\end{center}
\end{figure}
\subsection*{Static Public Member Functions}
\begin{DoxyCompactItemize}
\item 
static T \hyperlink{a00129_a45f0f552711f33392f33693a88fb20b3}{Create\-Instance$<$ T $>$} (params object\mbox{[}$\,$\mbox{]} args)
\begin{DoxyCompactList}\small\item\em Creates an instance of type T. \end{DoxyCompactList}\item 
static object \hyperlink{a00129_a9b8690ff760f41b0a7ef46626949c777}{Create\-Instance} (Type type, params object\mbox{[}$\,$\mbox{]} args)
\begin{DoxyCompactList}\small\item\em Creates an instance of the specified type. \end{DoxyCompactList}\item 
static T \hyperlink{a00129_aadf73df00d450ae49ceb8d78ac254b6d}{Get\-Attribute$<$ T $>$} (Property\-Info property, bool inherit)
\begin{DoxyCompactList}\small\item\em Gets the first attribute of type T on property. \end{DoxyCompactList}\item 
static T\mbox{[}$\,$\mbox{]} \hyperlink{a00129_adb0641e341c8468906b175f3f982ab6b}{Get\-Attributes$<$ T $>$} (Property\-Info property, bool inherit)
\begin{DoxyCompactList}\small\item\em Gets the attributes of type T on property. \end{DoxyCompactList}\item 
static New\-Expression \hyperlink{a00129_a7f2e39949787d37053702e7ea547ee69}{Get\-Constructor$<$ T $>$} (Expression$<$ Func$<$ T $>$$>$ expression)
...
static Property\-Info \hyperlink{a00129_afaa6e2741145eabea34c625684fb4636}{Get\-Property$<$ T\-Model $>$} (Expression$<$ Func$<$ T\-Model, object $>$$>$ expression)
...
\begin{DoxyCompactItemize}
\item 
static Member\-Expression \hyperlink{a00129_ab462ff86486973f2eee6785bed535cdc}{Get\-Member\-Expression$<$ T\-Model, T $>$} (Expression$<$ Func$<$ T\-Model, T $>$$>$ expression)
...
\hypertarget{a00129_a9b8690ff760f41b0a7ef46626949c777}{\index{Csv\-Helper\-::\-Reflection\-Helper@{Csv\-Helper\-::\-Reflection\-Helper}!Create\-Instance@{Create\-Instance}}
...
)\hspace{0.3cm}{\ttfamily [static]}}}\label{a00129_a9b8690ff760f41b0a7ef46626949c777}
...
\end{DoxyCode}
\hypertarget{a00129_a45f0f552711f33392f33693a88fb20b3}{\index{Csv\-Helper\-::\-Reflection\-Helper@{Csv\-Helper\-::\-Reflection\-Helper}!Create\-Instance$<$ T $>$@{Create\-Instance$<$ T $>$}}
...
\item[{params object\mbox{[}$\,$\mbox{]}}]{args}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}}\label{a00129_a45f0f552711f33392f33693a88fb20b3}
...
32 \textcolor{preprocessor}{}            \textcolor{keywordflow}{return} (T)\hyperlink{a00129_a9b8690ff760f41b0a7ef46626949c777}{CreateInstance}( typeof( T ), args );
33 \textcolor{preprocessor}{#endif}
34 \textcolor{preprocessor}{}        \}
\end{DoxyCode}
\hypertarget{a00129_aadf73df00d450ae49ceb8d78ac254b6d}{\index{Csv\-Helper\-::\-Reflection\-Helper@{Csv\-Helper\-::\-Reflection\-Helper}!Get\-Attribute$<$ T $>$@{Get\-Attribute$<$ T $>$}}
...
\item[{bool}]{inherit}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}}\label{a00129_aadf73df00d450ae49ceb8d78ac254b6d}
...
81         \}
\end{DoxyCode}
\hypertarget{a00129_adb0641e341c8468906b175f3f982ab6b}{\index{Csv\-Helper\-::\-Reflection\-Helper@{Csv\-Helper\-::\-Reflection\-Helper}!Get\-Attributes$<$ T $>$@{Get\-Attributes$<$ T $>$}}
...
\item[{bool}]{inherit}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}}\label{a00129_adb0641e341c8468906b175f3f982ab6b}
...
94         \}
\end{DoxyCode}
\hypertarget{a00129_a7f2e39949787d37053702e7ea547ee69}{\index{Csv\-Helper\-::\-Reflection\-Helper@{Csv\-Helper\-::\-Reflection\-Helper}!Get\-Constructor$<$ T $>$@{Get\-Constructor$<$ T $>$}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}}\label{a00129_a7f2e39949787d37053702e7ea547ee69}
...
112         \}
\end{DoxyCode}
\hypertarget{a00129_ab462ff86486973f2eee6785bed535cdc}{\index{Csv\-Helper\-::\-Reflection\-Helper@{Csv\-Helper\-::\-Reflection\-Helper}!Get\-Member\-Expression$<$ T\-Model, T $>$@{Get\-Member\-Expression$<$ T\-Model, T $>$}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}}\label{a00129_ab462ff86486973f2eee6785bed535cdc}
...
158         \}
\end{DoxyCode}
\hypertarget{a00129_afaa6e2741145eabea34c625684fb4636}{\index{Csv\-Helper\-::\-Reflection\-Helper@{Csv\-Helper\-::\-Reflection\-Helper}!Get\-Property$<$ T\-Model $>$@{Get\-Property$<$ T\-Model $>$}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}}\label{a00129_afaa6e2741145eabea34c625684fb4636}
...
125             \{
126                 \textcolor{keywordflow}{throw} \textcolor{keyword}{new} \hyperlink{a00042}{CsvConfigurationException}( $\textcolor{stringliteral}{"'\{member.Name\}' is not a
...
\item 
packages/\-Csv\-Helper.\-2.\-16.\-0.\-0/src/\-Csv\-Helper/\hyperlink{a00218}{Reflection\-Helper.\-cs}\end{DoxyCompactItemize}
