...
\item {\bfseries Inside the \hyperlink{a00156}{Yarn\-Spinner} folder, open the {\ttfamily Examples/\-Yarn Spinner Basic Example} scene.}
...
These three classes exist in the {\ttfamily \hyperlink{a00154}{Yarn.\-Unity}} namespace. To create your subclasses of {\ttfamily Dialogue\-U\-I\-Behaviour} and {\ttfamily Variable\-Storage\-Behaviour}, you'll need to add the following code to the top of your C\# code\-: \begin{DoxyVerb}using Yarn.Unity;
\end{DoxyVerb}
