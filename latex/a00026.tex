...
\subsection*{\hyperlink{a00045}{Yarn} Spinner Quick Start}

Here's how to quickly jump in to \hyperlink{a00045}{Yarn} Spinner if you're already familiar with Unity.
...
\item Inside the \hyperlink{a00359}{Yarn\-Spinner} folder, {\bfseries open the {\ttfamily Examples/\-Yarn Spinner Basic Example} scene.}
