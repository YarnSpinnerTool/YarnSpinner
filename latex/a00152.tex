\hypertarget{a00152}{\section{Yarn.\-Program Class Reference}
\label{a00152}\index{Yarn.\-Program@{Yarn.\-Program}}
}
...
\begin{center}
\leavevmode
\includegraphics[width=184pt]{a00717}
\end{center}
\end{figure}
\subsection*{Public Member Functions}
\begin{DoxyCompactItemize}
\item 
void \hyperlink{a00152_a977d1ed02e3f6f39d30dfea1663e7927}{Load\-Strings} (Dictionary$<$ string, string $>$ new\-Strings)
\begin{DoxyCompactList}\small\item\em Loads a new string table into the program. \end{DoxyCompactList}\item 
string \hyperlink{a00152_a9baf491479375aa8c3aa2b0c31cf0932}{Register\-String} (string the\-String, string node\-Name, string line\-I\-D, int line\-Number, bool localisable)
\item 
string \hyperlink{a00152_a14737b93594c4aab25c59cb0a3c918f7}{Get\-String} (string key)
\item 
string \hyperlink{a00152_a2f5bb468ce53eb7bbe647e3c11ddbb61}{Dump\-Code} (\hyperlink{a00129}{Library} l)
\item 
string \hyperlink{a00152_aad8029f37832ff1985fad6a31e51afd8}{Get\-Text\-For\-Node} (string node\-Name)
\item 
void \hyperlink{a00152_afd3385ca1f7589b3b9dae3646e4fee84}{Include} (\hyperlink{a00152}{Program} other\-Program)
\end{DoxyCompactItemize}
\subsection*{Package Attributes}
\begin{DoxyCompactItemize}
\item 
Dictionary$<$ string, string $>$ \hyperlink{a00152_a59263e00cecfe36d9881b4c30b048f09}{strings} = new Dictionary$<$string, string$>$()
\item 
Dictionary$<$ string, \hyperlink{a00131}{Line\-Info} $>$ \hyperlink{a00152_a0d4da395947767b4a1eaaff8a9842adc}{line\-Info} = new Dictionary$<$string, \hyperlink{a00131}{Line\-Info}$>$()
\item 
Dictionary$<$ string, \hyperlink{a00051_a00379}{Node} $>$ \hyperlink{a00152_a3f4928a577c88263ad016be259b175c4}{nodes} = new Dictionary$<$string, \hyperlink{a00051_a00379}{Node}$>$()
\end{DoxyCompactItemize}
\subsection*{Properties}
\begin{DoxyCompactItemize}
\item 
Dictionary$<$ string, string $>$ \hyperlink{a00152_aa8fedbfceaf931d1da3f600eaab6ae87}{untagged\-Strings}\hspace{0.3cm}{\ttfamily  \mbox{[}get\mbox{]}}
\end{DoxyCompactItemize}
\subsection*{Private Attributes}
\begin{DoxyCompactItemize}
\item 
int \hyperlink{a00152_a8ef1d10094ef00311aade6715ba78ec7}{string\-Count} = 0
\end{DoxyCompactItemize}
...
\hypertarget{a00152_a2f5bb468ce53eb7bbe647e3c11ddbb61}{\index{Yarn\-::\-Program@{Yarn\-::\-Program}!Dump\-Code@{Dump\-Code}}
...
)}}\label{a00152_a2f5bb468ce53eb7bbe647e3c11ddbb61}
...
214         \}
\end{DoxyCode}
\hypertarget{a00152_a14737b93594c4aab25c59cb0a3c918f7}{\index{Yarn\-::\-Program@{Yarn\-::\-Program}!Get\-String@{Get\-String}}
...
\item[{string}]{key}
\end{DoxyParamCaption}
)}}\label{a00152_a14737b93594c4aab25c59cb0a3c918f7}
...
160         \}
\end{DoxyCode}
\hypertarget{a00152_aad8029f37832ff1985fad6a31e51afd8}{\index{Yarn\-::\-Program@{Yarn\-::\-Program}!Get\-Text\-For\-Node@{Get\-Text\-For\-Node}}
...
\end{DoxyParamCaption}
)}}\label{a00152_aad8029f37832ff1985fad6a31e51afd8}
...
\begin{DoxyCode}
217         \{
218             \textcolor{keywordflow}{return} this.GetString(\hyperlink{a00152_a3f4928a577c88263ad016be259b175c4}{nodes}[nodeName].sourceTextStringID);
219         \}
\end{DoxyCode}
\hypertarget{a00152_afd3385ca1f7589b3b9dae3646e4fee84}{\index{Yarn\-::\-Program@{Yarn\-::\-Program}!Include@{Include}}
...
\end{DoxyParamCaption}
)}}\label{a00152_afd3385ca1f7589b3b9dae3646e4fee84}
...
\begin{DoxyCode}
222         \{
223             \textcolor{keywordflow}{foreach} (var otherNodeName \textcolor{keywordflow}{in} otherProgram.nodes)
224             \{
225 
226                 \textcolor{keywordflow}{if} (\hyperlink{a00152_a3f4928a577c88263ad016be259b175c4}{nodes}.ContainsKey(otherNodeName.Key))
227                 \{
228                     \textcolor{keywordflow}{throw} \textcolor{keyword}{new} InvalidOperationException(\textcolor{keywordtype}{string}.Format(CultureInfo.CurrentCulture, \textcolor{stringliteral}{"This
       program already contains a node named \{0\}"}, otherNodeName.Key));
229                 \}
230 
231                 \hyperlink{a00152_a3f4928a577c88263ad016be259b175c4}{nodes}[otherNodeName.Key] = otherNodeName.Value;
232             \}
233 
234             \textcolor{keywordflow}{foreach} (var otherString \textcolor{keywordflow}{in} otherProgram.strings)
235             \{
236 
237                 \textcolor{keywordflow}{if} (\hyperlink{a00152_a3f4928a577c88263ad016be259b175c4}{nodes}.ContainsKey(otherString.Key))
238                 \{
239                     \textcolor{keywordflow}{throw} \textcolor{keyword}{new} InvalidOperationException(\textcolor{keywordtype}{string}.Format(CultureInfo.CurrentCulture, \textcolor{stringliteral}{"This
       program already contains a string with key \{0\}"}, otherString.Key));
240                 \}
241 
242                 \hyperlink{a00152_a59263e00cecfe36d9881b4c30b048f09}{strings}[otherString.Key] = otherString.Value;
243             \}
244         \}
\end{DoxyCode}
\hypertarget{a00152_a977d1ed02e3f6f39d30dfea1663e7927}{\index{Yarn\-::\-Program@{Yarn\-::\-Program}!Load\-Strings@{Load\-Strings}}
...
\end{DoxyParamCaption}
)}}\label{a00152_a977d1ed02e3f6f39d30dfea1663e7927}
...
128             \{
129                 \hyperlink{a00152_a59263e00cecfe36d9881b4c30b048f09}{strings}[entry.Key] = entry.Value;
130             \}
131         \}
\end{DoxyCode}
\hypertarget{a00152_a9baf491479375aa8c3aa2b0c31cf0932}{\index{Yarn\-::\-Program@{Yarn\-::\-Program}!Register\-String@{Register\-String}}
...
\end{DoxyParamCaption}
)}}\label{a00152_a9baf491479375aa8c3aa2b0c31cf0932}
...
139                 key = string.Format(CultureInfo.InvariantCulture, \textcolor{stringliteral}{"\{0\}-\{1\}"}, nodeName, 
      \hyperlink{a00152_a8ef1d10094ef00311aade6715ba78ec7}{stringCount}++);
...
\hypertarget{a00152_a0d4da395947767b4a1eaaff8a9842adc}{\index{Yarn\-::\-Program@{Yarn\-::\-Program}!line\-Info@{line\-Info}}
...
\hypertarget{a00152_a3f4928a577c88263ad016be259b175c4}{\index{Yarn\-::\-Program@{Yarn\-::\-Program}!nodes@{nodes}}
...
\hypertarget{a00152_a8ef1d10094ef00311aade6715ba78ec7}{\index{Yarn\-::\-Program@{Yarn\-::\-Program}!string\-Count@{string\-Count}}
...
\hypertarget{a00152_a59263e00cecfe36d9881b4c30b048f09}{\index{Yarn\-::\-Program@{Yarn\-::\-Program}!strings@{strings}}
...
\hypertarget{a00152_aa8fedbfceaf931d1da3f600eaab6ae87}{\index{Yarn\-::\-Program@{Yarn\-::\-Program}!untagged\-Strings@{untagged\-Strings}}
