\hypertarget{a00089}{\section{Example\-Variable\-Storage Class Reference}
\label{a00089}\index{Example\-Variable\-Storage@{Example\-Variable\-Storage}}
}
...
\begin{center}
\leavevmode
\includegraphics[width=294pt]{a00396}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{a00397}
\end{center}
\end{figure}
\subsection*{Classes}
...
\begin{DoxyCompactItemize}
\item 
override void \hyperlink{a00089_a3a05d66cdacadb2e9b618cd0aef45f84}{Reset\-To\-Defaults} ()
\begin{DoxyCompactList}\small\item\em Erase all variables and reset to default values. \end{DoxyCompactList}\item 
override void \hyperlink{a00089_ac4265c1c9da485f13a6b05784b0f668d}{Set\-Value} (string variable\-Name, \hyperlink{a00187}{Yarn.\-Value} value)
\begin{DoxyCompactList}\small\item\em Set a variable's value. \end{DoxyCompactList}\item 
override \hyperlink{a00187}{Yarn.\-Value} \hyperlink{a00089_a741593be1a299dcc2136f05b9b4a995a}{Get\-Value} (string variable\-Name)
\begin{DoxyCompactList}\small\item\em Get a variable's value. \end{DoxyCompactList}\item 
override void \hyperlink{a00089_a0ce614bee8d5b220500fb765390b4ca3}{Clear} ()
...
\begin{DoxyCompactItemize}
\item 
\hyperlink{a00089_a00376}{Default\-Variable}\mbox{[}$\,$\mbox{]} \hyperlink{a00089_a464c8a4ff6a3c624602d0adc55dfc59a}{default\-Variables}
\begin{DoxyCompactList}\small\item\em Our list of default variables, for debugging. \end{DoxyCompactList}\item 
Unity\-Engine.\-U\-I.\-Text \hyperlink{a00089_a9893656e3683711eb78441b30c52a600}{debug\-Text\-View}
...
\begin{DoxyCompactItemize}
\item 
void \hyperlink{a00089_ab6a56afc687455f360876eff67891163}{Awake} ()
\begin{DoxyCompactList}\small\item\em Reset to our default values when the game starts. \end{DoxyCompactList}\item 
void \hyperlink{a00089_af646a17cfd63039a25149f8fc0776dcb}{Update} ()
...
\begin{DoxyCompactItemize}
\item 
Dictionary$<$ string, \hyperlink{a00187}{Yarn.\-Value} $>$ \hyperlink{a00089_a4a4fec7b4ad707cd0603393dd57de96c}{variables} = new Dictionary$<$string, \hyperlink{a00187}{Yarn.\-Value}$>$ ()
...
\index{Example\-Variable\-Storage\-::\-Default\-Variable@{Example\-Variable\-Storage\-::\-Default\-Variable}}\label{a00376}
...
\begin{center}
\leavevmode
\includegraphics[width=236pt]{a00386}
\end{center}
\end{figure}
...
\hypertarget{a00089_ab6a56afc687455f360876eff67891163}{\index{Example\-Variable\-Storage@{Example\-Variable\-Storage}!Awake@{Awake}}
...
)\hspace{0.3cm}{\ttfamily [private]}}}\label{a00089_ab6a56afc687455f360876eff67891163}
...
\begin{DoxyCode}
62     \{
63         \hyperlink{a00089_a3a05d66cdacadb2e9b618cd0aef45f84}{ResetToDefaults} ();
64     \}
\end{DoxyCode}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{a00089_ab6a56afc687455f360876eff67891163_cgraph}
\end{center}
\end{figure}


\hypertarget{a00089_a0ce614bee8d5b220500fb765390b4ca3}{\index{Example\-Variable\-Storage@{Example\-Variable\-Storage}!Clear@{Clear}}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{a00089_a0ce614bee8d5b220500fb765390b4ca3}
...
Reimplemented from \hyperlink{a00191_a587fe10b367ace190e10f3bcb590a53c}{Yarn.\-Unity.\-Variable\-Storage\-Behaviour}.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{a00089_a0ce614bee8d5b220500fb765390b4ca3_icgraph}
\end{center}
\end{figure}


\hypertarget{a00191_add85a45dd65a5d4bd41c9d5ce5f77d19}{\index{Example\-Variable\-Storage@{Example\-Variable\-Storage}!Get\-Number@{Get\-Number}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}, {\ttfamily [inherited]}}}\label{a00191_add85a45dd65a5d4bd41c9d5ce5f77d19}
...
496         \}
\end{DoxyCode}
\hypertarget{a00089_a741593be1a299dcc2136f05b9b4a995a}{\index{Example\-Variable\-Storage@{Example\-Variable\-Storage}!Get\-Value@{Get\-Value}}
...
\item[{string}]{variable\-Name}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{a00089_a741593be1a299dcc2136f05b9b4a995a}
...
Reimplemented from \hyperlink{a00191_ac6ebafcbebc2b2d71eba8562490a2f1e}{Yarn.\-Unity.\-Variable\-Storage\-Behaviour}.
...
128         \textcolor{keywordflow}{if} (\hyperlink{a00089_a4a4fec7b4ad707cd0603393dd57de96c}{variables}.ContainsKey(variableName) == \textcolor{keyword}{false})
129             \textcolor{keywordflow}{return} Yarn.Value.NULL;
130         
131         \textcolor{keywordflow}{return} \hyperlink{a00089_a4a4fec7b4ad707cd0603393dd57de96c}{variables} [variableName];
132     \}
\end{DoxyCode}
\hypertarget{a00089_a3a05d66cdacadb2e9b618cd0aef45f84}{\index{Example\-Variable\-Storage@{Example\-Variable\-Storage}!Reset\-To\-Defaults@{Reset\-To\-Defaults}}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{a00089_a3a05d66cdacadb2e9b618cd0aef45f84}
...
Implements \hyperlink{a00191_a33fcbff56561e53e0a70b59c56f0c3af}{Yarn.\-Unity.\-Variable\-Storage\-Behaviour}.
...
\begin{DoxyCode}
68     \{
69         \hyperlink{a00089_a0ce614bee8d5b220500fb765390b4ca3}{Clear} ();
70 
...
73         \textcolor{keywordflow}{foreach} (var variable \textcolor{keywordflow}{in} \hyperlink{a00089_a464c8a4ff6a3c624602d0adc55dfc59a}{defaultVariables}) \{
74             
...
109             \}
110 
111             var v = \textcolor{keyword}{new} \hyperlink{a00187}{Yarn.Value}(value);
112 
113             \hyperlink{a00089_ac4265c1c9da485f13a6b05784b0f668d}{SetValue} (\textcolor{stringliteral}{"$"} + variable.name, v);
114         \}
115     \}
\end{DoxyCode}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{a00089_a3a05d66cdacadb2e9b618cd0aef45f84_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{a00089_a3a05d66cdacadb2e9b618cd0aef45f84_icgraph}
\end{center}
\end{figure}


\hypertarget{a00191_ac0d2f2e081944ad197992a26ad1a833c}{\index{Example\-Variable\-Storage@{Example\-Variable\-Storage}!Set\-Number@{Set\-Number}}
...
\item[{float}]{number}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}, {\ttfamily [inherited]}}}\label{a00191_ac0d2f2e081944ad197992a26ad1a833c}
...
490         \}
\end{DoxyCode}
\hypertarget{a00089_ac4265c1c9da485f13a6b05784b0f668d}{\index{Example\-Variable\-Storage@{Example\-Variable\-Storage}!Set\-Value@{Set\-Value}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{a00089_ac4265c1c9da485f13a6b05784b0f668d}
...
Reimplemented from \hyperlink{a00191_a25f979b062d63c9e886fe7070ce4561b}{Yarn.\-Unity.\-Variable\-Storage\-Behaviour}.
...
121         \hyperlink{a00089_a4a4fec7b4ad707cd0603393dd57de96c}{variables}[variableName] = \textcolor{keyword}{new} \hyperlink{a00187}{Yarn.Value}(value);
122     \}
\end{DoxyCode}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{a00089_ac4265c1c9da485f13a6b05784b0f668d_icgraph}
\end{center}
\end{figure}


\hypertarget{a00089_af646a17cfd63039a25149f8fc0776dcb}{\index{Example\-Variable\-Storage@{Example\-Variable\-Storage}!Update@{Update}}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}}\label{a00089_af646a17cfd63039a25149f8fc0776dcb}
...
\begin{DoxyCode}
142     \{
143         \textcolor{keywordflow}{if} (\hyperlink{a00089_a9893656e3683711eb78441b30c52a600}{debugTextView} != null) \{
144             var stringBuilder = \textcolor{keyword}{new} System.Text.StringBuilder ();
145             \textcolor{keywordflow}{foreach} (KeyValuePair<string,Yarn.Value> item \textcolor{keywordflow}{in} \hyperlink{a00089_a4a4fec7b4ad707cd0603393dd57de96c}{variables}) \{
...
\hypertarget{a00089_a9893656e3683711eb78441b30c52a600}{\index{Example\-Variable\-Storage@{Example\-Variable\-Storage}!debug\-Text\-View@{debug\-Text\-View}}
\index{debug\-Text\-View@{debug\-Text\-View}!ExampleVariableStorage@{Example\-Variable\-Storage}}
\subsubsection[{debug\-Text\-View}]{\setlength{\rightskip}{0pt plus 5cm}Unity\-Engine.\-U\-I.\-Text Example\-Variable\-Storage.\-debug\-Text\-View}}\label{a00089_a9893656e3683711eb78441b30c52a600}
...
\hypertarget{a00089_a464c8a4ff6a3c624602d0adc55dfc59a}{\index{Example\-Variable\-Storage@{Example\-Variable\-Storage}!default\-Variables@{default\-Variables}}
\index{default\-Variables@{default\-Variables}!ExampleVariableStorage@{Example\-Variable\-Storage}}
\subsubsection[{default\-Variables}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Default\-Variable} \mbox{[}$\,$\mbox{]} Example\-Variable\-Storage.\-default\-Variables}}\label{a00089_a464c8a4ff6a3c624602d0adc55dfc59a}
...
\hypertarget{a00089_a4a4fec7b4ad707cd0603393dd57de96c}{\index{Example\-Variable\-Storage@{Example\-Variable\-Storage}!variables@{variables}}
\index{variables@{variables}!ExampleVariableStorage@{Example\-Variable\-Storage}}
\subsubsection[{variables}]{\setlength{\rightskip}{0pt plus 5cm}Dictionary$<$string, {\bf Yarn.\-Value}$>$ Example\-Variable\-Storage.\-variables = new Dictionary$<$string, {\bf Yarn.\-Value}$>$ ()\hspace{0.3cm}{\ttfamily [private]}}}\label{a00089_a4a4fec7b4ad707cd0603393dd57de96c}
...
\item 
Unity/\-Assets/\-Yarn\-Spinner/\-Examples/\-Demo\-Scripts/\hyperlink{a00297}{Example\-Variable\-Storage.\-cs}\end{DoxyCompactItemize}
