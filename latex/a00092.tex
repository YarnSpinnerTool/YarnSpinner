...
\begin{DoxyCode}
553         \{
554             \hyperlink{a00092_a903f18cdcc66c28ceab5a43c41fe074dab4daca084ad9eabfc8de231929477ed6}{V1}
555         \}
\end{DoxyCode}
...
\begin{DoxyCode}
595                                 \{
596             \textcolor{keywordflow}{return} program.DumpCode (\hyperlink{a00092_ae660d4cfb6e296358d2f61d8ee74c66a}{library});
597         \}
\end{DoxyCode}
...
\begin{DoxyCode}
599                                     \{
600             \textcolor{keywordflow}{return} program.DumpCode (\hyperlink{a00092_ae660d4cfb6e296358d2f61d8ee74c66a}{library});
601         \}
\end{DoxyCode}
...
565                     \textcolor{keywordflow}{return} \hyperlink{a00092_a070898dbc07fd7d0a74d7c3ac1848beb}{GetCompiledProgramV1}();
...
546         \}
\end{DoxyCode}
\hypertarget{a00092_a20ef38a17e4a346de3b572b85052c1d1}{\index{Yarn\-::\-Dialogue@{Yarn\-::\-Dialogue}!Get\-Tags\-For\-All\-Nodes@{Get\-Tags\-For\-All\-Nodes}}
...
{}
\end{DoxyParamCaption}
)}}\label{a00092_a20ef38a17e4a346de3b572b85052c1d1}
...
513 
514             \textcolor{keywordflow}{foreach} (var node \textcolor{keywordflow}{in} \hyperlink{a00092_a0a1cca92325f430425d784d416cb5c2b}{program}.\hyperlink{a00152_a3f4928a577c88263ad016be259b175c4}{nodes}) \{
...
524         \}
\end{DoxyCode}
\hypertarget{a00092_ab85166316a6c5aadce336316406ed164}{\index{Yarn\-::\-Dialogue@{Yarn\-::\-Dialogue}!Get\-Tags\-For\-Node@{Get\-Tags\-For\-Node}}
...
\end{DoxyParamCaption}
)}}\label{a00092_ab85166316a6c5aadce336316406ed164}
...
\begin{DoxyCode}
527                                                                    \{
528             \textcolor{keywordflow}{if} (\hyperlink{a00092_a0a1cca92325f430425d784d416cb5c2b}{program}.\hyperlink{a00152_a3f4928a577c88263ad016be259b175c4}{nodes}.Count == 0) \{
529                 \hyperlink{a00092_a9801e83dd044d6498fdf6ebcc6bec5ac}{LogErrorMessage} (\textcolor{stringliteral}{"No nodes are loaded!"});
530                 \textcolor{keywordflow}{return} null;
531             \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (\hyperlink{a00092_a0a1cca92325f430425d784d416cb5c2b}{program}.\hyperlink{a00152_a3f4928a577c88263ad016be259b175c4}{nodes}.ContainsKey(nodeName)) \{
532                 \textcolor{keywordflow}{return} program.GetTagsForNode (nodeName);
533             \} \textcolor{keywordflow}{else} \{
534                 \hyperlink{a00092_a9801e83dd044d6498fdf6ebcc6bec5ac}{LogErrorMessage} (\textcolor{stringliteral}{"No node named "} + nodeName);
...
\begin{DoxyCode}
603                                                 \{
604             \textcolor{keywordflow}{if} (\hyperlink{a00092_a0a1cca92325f430425d784d416cb5c2b}{program} == null) \{
605                 \hyperlink{a00092_a9801e83dd044d6498fdf6ebcc6bec5ac}{LogErrorMessage} (\textcolor{stringliteral}{"Tried to call NodeExists, but no nodes "} +
606                                  \textcolor{stringliteral}{"have been compiled!"});
607                 \textcolor{keywordflow}{return} \textcolor{keyword}{false};
608             \}
609             \textcolor{keywordflow}{if} (\hyperlink{a00092_a0a1cca92325f430425d784d416cb5c2b}{program}.\hyperlink{a00152_a3f4928a577c88263ad016be259b175c4}{nodes} == null || \hyperlink{a00092_a0a1cca92325f430425d784d416cb5c2b}{program}.\hyperlink{a00152_a3f4928a577c88263ad016be259b175c4}{nodes}.Count == 0) \{
610                 \hyperlink{a00092_a381f48bb0fbb294f8cf44ca57f11be31}{LogDebugMessage} (\textcolor{stringliteral}{"Called NodeExists, but there are zero nodes. "} +
...
589 
590             \hyperlink{a00092_a0a1cca92325f430425d784d416cb5c2b}{program} = null;
591 
592         \}
\end{DoxyCode}
