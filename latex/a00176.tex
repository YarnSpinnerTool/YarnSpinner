\hypertarget{a00176}{\section{Yarn.\-Unity.\-Yarn\-Spinner\-Editor\-Window Class Reference}
\label{a00176}\index{Yarn.\-Unity.\-Yarn\-Spinner\-Editor\-Window@{Yarn.\-Unity.\-Yarn\-Spinner\-Editor\-Window}}
}
...
\begin{center}
\leavevmode
\includegraphics[width=224pt]{a00774}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=224pt]{a00775}
\end{center}
\end{figure}
\subsection*{Classes}
...
\begin{DoxyCompactItemize}
\item 
void \hyperlink{a00176_a406febf62d77eaabc235f6316e537345}{Update\-Yarn\-Script\-List} ()
\item 
void \hyperlink{a00176_aeba1f39189758bd91bdce298e8859947}{On\-Enable} ()
\item 
void \hyperlink{a00176_ae4faac1a6b0cc9710b20267dc4b88995}{Refresh\-All\-Results} ()
\item 
void \hyperlink{a00176_ab84b77da285227c4ab4e1366131dd2b5}{Compile\-All\-Scripts} ()
\item 
void \hyperlink{a00176_aec84840262ae8fd7d84605778de1dc39}{On\-G\-U\-I} ()
\item 
delegate void \hyperlink{a00176_a8f57c8688d68ae4a5ce708e665902bc0}{G\-U\-I\-Callback} (int complete, int total)
\item 
void \hyperlink{a00176_a8e59ec20bd21bb1f8a6d4f02980f624b}{Check\-All\-Files} (\hyperlink{a00176_a8f57c8688d68ae4a5ce708e665902bc0}{G\-U\-I\-Callback} callback=null)
\item 
\hyperlink{a00176_a00365}{Validation\-Message}\mbox{[}$\,$\mbox{]} \hyperlink{a00176_a6f2bf42b228ea29c6477e369226db8b6}{Validate\-File} (Text\-Asset script, \hyperlink{a00047}{Analysis.\-Context} analysis\-Context, out \hyperlink{a00039_ab24848d7951ce44eb3c7768c6ee10385}{Checker\-Result.\-State} result)
\item 
I\-Enumerable\\*
$<$ \hyperlink{a00081}{Yarn.\-Analysis.\-Diagnosis} $>$ \hyperlink{a00176_a9c207786c349120dc439bdce53072191}{Analyse\-Environment} ()
\end{DoxyCompactItemize}
\subsection*{Static Private Member Functions}
\begin{DoxyCompactItemize}
\item 
static void \hyperlink{a00176_a2084e2ce6ccf18094a992985aa5330fb}{Show\-Window} ()
\item 
static void \hyperlink{a00176_a1a7e1a855bb2a9549eb1c0eb292c9b85}{Draw\-Script\-G\-U\-I} (\hyperlink{a00039}{Checker\-Result} result)
\end{DoxyCompactItemize}
...
\hypertarget{a00176_a9c207786c349120dc439bdce53072191}{\index{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window@{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window}!Analyse\-Environment@{Analyse\-Environment}}
...
)\hspace{0.3cm}{\ttfamily [private]}}}\label{a00176_a9c207786c349120dc439bdce53072191}
...
518             ));
519 
520             var results = \textcolor{keyword}{new} List<\hyperlink{a00081}{Yarn.Analysis.Diagnosis}>();
521 
...
536                                 var diagnosis = \textcolor{keyword}{new} \hyperlink{a00081}{Yarn.Analysis.Diagnosis} (message
...
545         \}
\end{DoxyCode}
\hypertarget{a00176_a8e59ec20bd21bb1f8a6d4f02980f624b}{\index{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window@{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window}!Check\-All\-Files@{Check\-All\-Files}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}}\label{a00176_a8e59ec20bd21bb1f8a6d4f02980f624b}
...
361             var analysisContext = \textcolor{keyword}{new} \hyperlink{a00047}{Yarn.Analysis.Context}();
362 
...
374             \hyperlink{a00176_a406febf62d77eaabc235f6316e537345}{UpdateYarnScriptList}();
375 
376             \textcolor{comment}{// Next, compile each one.}
377             \textcolor{keywordflow}{foreach} (var result \textcolor{keywordflow}{in} \hyperlink{a00176_aa85ab7bd194e5425b991b9c216d4d10e}{checkResults}) \{
378 
379                 \textcolor{comment}{// Attempt to compile the file. Record any compiler messages.}
380                 CheckerResult.State state;
381 
382                 var messages = \hyperlink{a00176_a6f2bf42b228ea29c6477e369226db8b6}{ValidateFile}(result.script, analysisContext, out state);
383 
...
399             \}
400 
401             var results = \textcolor{keyword}{new} List<\hyperlink{a00081}{Yarn.Analysis.Diagnosis}>();
402 
...
407 
408 
409             var environmentAnalyses = \hyperlink{a00176_a9c207786c349120dc439bdce53072191}{AnalyseEnvironment} ();
410             results.AddRange (environmentAnalyses);
411 
412             \hyperlink{a00176_a25c92cbfdd09661a96714d05b14af886}{diagnoses} = results;
413 
414         \}
\end{DoxyCode}
\hypertarget{a00176_ab84b77da285227c4ab4e1366131dd2b5}{\index{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window@{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window}!Compile\-All\-Scripts@{Compile\-All\-Scripts}}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}}\label{a00176_ab84b77da285227c4ab4e1366131dd2b5}
...
183 
184             \textcolor{keywordflow}{foreach} (var entry \textcolor{keywordflow}{in} \hyperlink{a00176_aa85ab7bd194e5425b991b9c216d4d10e}{checkResults}) \{
185 
...
190                 \textcolor{keywordflow}{if} (timeSinceStart > \hyperlink{a00176_a62a14b3fbaf2da41154ebad0eb7b6d3f}{timeBeforeProgressBar}) \{
191 
...
203                 \}
204 
205                 var variableStorage = \textcolor{keyword}{new} \hyperlink{a00126}{Yarn.MemoryVariableStore}();
206 
...
252         \}
\end{DoxyCode}
\hypertarget{a00176_a1a7e1a855bb2a9549eb1c0eb292c9b85}{\index{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window@{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window}!Draw\-Script\-G\-U\-I@{Draw\-Script\-G\-U\-I}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}}\label{a00176_a1a7e1a855bb2a9549eb1c0eb292c9b85}
...
321                     image = \hyperlink{a00101_ab8afce565cd2ad1543d1e32e7e589e77}{Icons.notTestedIcon};
322                     \textcolor{keywordflow}{break};
323                 \textcolor{keywordflow}{case} CheckerResult.State.Passed:
324                     image = \hyperlink{a00101_aec8aea03eb6e31771ebc98e0611fff79}{Icons.successIcon};
325                     \textcolor{keywordflow}{break};
326                 \textcolor{keywordflow}{case} CheckerResult.State.Failed:
327                     image = \hyperlink{a00101_aae7cc0e5016db04a90b2aa0e80957626}{Icons.failedIcon};
...
353         \}
\end{DoxyCode}
\hypertarget{a00176_a8f57c8688d68ae4a5ce708e665902bc0}{\index{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window@{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window}!G\-U\-I\-Callback@{G\-U\-I\-Callback}}
...
\item[{int}]{total}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}}\label{a00176_a8f57c8688d68ae4a5ce708e665902bc0}
\hypertarget{a00176_aeba1f39189758bd91bdce298e8859947}{\index{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window@{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window}!On\-Enable@{On\-Enable}}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}}\label{a00176_aeba1f39189758bd91bdce298e8859947}
...
116             this.titleContent.image = \hyperlink{a00101_aa78ab016ad041bc36850c8b20ba63972}{Icons.windowIcon};
117 
118             \textcolor{comment}{// Update the list of scripts known to the window}
119             \hyperlink{a00176_a406febf62d77eaabc235f6316e537345}{UpdateYarnScriptList}();
120 
121         \}
\end{DoxyCode}
\hypertarget{a00176_aec84840262ae8fd7d84605778de1dc39}{\index{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window@{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window}!On\-G\-U\-I@{On\-G\-U\-I}}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}}\label{a00176_aec84840262ae8fd7d84605778de1dc39}
...
261                     \hyperlink{a00176_ae4faac1a6b0cc9710b20267dc4b88995}{RefreshAllResults}();
262                 \}
263 
...
267                         \hyperlink{a00176_ab84b77da285227c4ab4e1366131dd2b5}{CompileAllScripts}();
268                     \}
269                 \}
270 
...
278                 \textcolor{keyword}{using} (var scroll = \textcolor{keyword}{new} EditorGUILayout.ScrollViewScope(
      \hyperlink{a00176_a2d9b9702b0980af9d4202aebd440124b}{scrollPos})) \{
279                     \hyperlink{a00176_a2d9b9702b0980af9d4202aebd440124b}{scrollPos} = scroll.scrollPosition;
280 
281                     \textcolor{keywordflow}{foreach} (var result \textcolor{keywordflow}{in} \hyperlink{a00176_aa85ab7bd194e5425b991b9c216d4d10e}{checkResults}) \{
282                         \hyperlink{a00176_a1a7e1a855bb2a9549eb1c0eb292c9b85}{DrawScriptGUI} (result);
283                     \}
284 
285                     \textcolor{comment}{// Draw any diagnoses that resulted}
286                     \textcolor{keywordflow}{foreach} (var diagnosis \textcolor{keywordflow}{in} \hyperlink{a00176_a25c92cbfdd09661a96714d05b14af886}{diagnoses}) \{
287 
...
312         \}
\end{DoxyCode}
\hypertarget{a00176_ae4faac1a6b0cc9710b20267dc4b88995}{\index{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window@{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window}!Refresh\-All\-Results@{Refresh\-All\-Results}}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}}\label{a00176_ae4faac1a6b0cc9710b20267dc4b88995}
...
136             \hyperlink{a00176_a8e59ec20bd21bb1f8a6d4f02980f624b}{CheckAllFiles}(delegate(\textcolor{keywordtype}{int} complete, \textcolor{keywordtype}{int} total) \{
137 
...
142                 \textcolor{keywordflow}{if} (timeSinceStart > \hyperlink{a00176_a62a14b3fbaf2da41154ebad0eb7b6d3f}{timeBeforeProgressBar}) \{
143 
...
162         \}
\end{DoxyCode}
\hypertarget{a00176_a2084e2ce6ccf18094a992985aa5330fb}{\index{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window@{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window}!Show\-Window@{Show\-Window}}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}}\label{a00176_a2084e2ce6ccf18094a992985aa5330fb}
...
109         \}
\end{DoxyCode}
\hypertarget{a00176_a406febf62d77eaabc235f6316e537345}{\index{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window@{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window}!Update\-Yarn\-Script\-List@{Update\-Yarn\-Script\-List}}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}}\label{a00176_a406febf62d77eaabc235f6316e537345}
...
86             \hyperlink{a00176_a25c92cbfdd09661a96714d05b14af886}{diagnoses} = \textcolor{keyword}{new} List<\hyperlink{a00081}{Yarn.Analysis.Diagnosis}>();
87 
...
103         \}
\end{DoxyCode}
\hypertarget{a00176_a6f2bf42b228ea29c6477e369226db8b6}{\index{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window@{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window}!Validate\-File@{Validate\-File}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}}\label{a00176_a6f2bf42b228ea29c6477e369226db8b6}
...
426             var variableStorage = \textcolor{keyword}{new} \hyperlink{a00126}{Yarn.MemoryVariableStore}();
427 
...
\hypertarget{a00176_aa85ab7bd194e5425b991b9c216d4d10e}{\index{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window@{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window}!check\-Results@{check\-Results}}
\index{check\-Results@{check\-Results}!Yarn::Unity::YarnSpinnerEditorWindow@{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window}}
\subsubsection[{check\-Results}]{\setlength{\rightskip}{0pt plus 5cm}List$<${\bf Checker\-Result}$>$ Yarn.\-Unity.\-Yarn\-Spinner\-Editor\-Window.\-check\-Results = new List$<${\bf Checker\-Result}$>$()\hspace{0.3cm}{\ttfamily [private]}}}\label{a00176_aa85ab7bd194e5425b991b9c216d4d10e}


Definition at line 67 of file Yarn\-Spinner\-Editor\-Window.\-cs.

\hypertarget{a00176_a25c92cbfdd09661a96714d05b14af886}{\index{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window@{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window}!diagnoses@{diagnoses}}
\index{diagnoses@{diagnoses}!Yarn::Unity::YarnSpinnerEditorWindow@{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window}}
\subsubsection[{diagnoses}]{\setlength{\rightskip}{0pt plus 5cm}List$<${\bf Yarn.\-Analysis.\-Diagnosis}$>$ Yarn.\-Unity.\-Yarn\-Spinner\-Editor\-Window.\-diagnoses = new List$<${\bf Yarn.\-Analysis.\-Diagnosis}$>$()\hspace{0.3cm}{\ttfamily [private]}}}\label{a00176_a25c92cbfdd09661a96714d05b14af886}


Definition at line 71 of file Yarn\-Spinner\-Editor\-Window.\-cs.

\hypertarget{a00176_a2d9b9702b0980af9d4202aebd440124b}{\index{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window@{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window}!scroll\-Pos@{scroll\-Pos}}
\index{scroll\-Pos@{scroll\-Pos}!Yarn::Unity::YarnSpinnerEditorWindow@{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window}}
\subsubsection[{scroll\-Pos}]{\setlength{\rightskip}{0pt plus 5cm}Vector2 Yarn.\-Unity.\-Yarn\-Spinner\-Editor\-Window.\-scroll\-Pos\hspace{0.3cm}{\ttfamily [private]}}}\label{a00176_a2d9b9702b0980af9d4202aebd440124b}


Definition at line 74 of file Yarn\-Spinner\-Editor\-Window.\-cs.

\hypertarget{a00176_a62a14b3fbaf2da41154ebad0eb7b6d3f}{\index{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window@{Yarn\-::\-Unity\-::\-Yarn\-Spinner\-Editor\-Window}!time\-Before\-Progress\-Bar@{time\-Before\-Progress\-Bar}}
...
\subsubsection[{time\-Before\-Progress\-Bar}]{\setlength{\rightskip}{0pt plus 5cm}const float Yarn.\-Unity.\-Yarn\-Spinner\-Editor\-Window.\-time\-Before\-Progress\-Bar = 0.\-1f\hspace{0.3cm}{\ttfamily [private]}}}\label{a00176_a62a14b3fbaf2da41154ebad0eb7b6d3f}
