\hypertarget{a00125}{\section{Yarn.\-Loader Class Reference}
\label{a00125}\index{Yarn.\-Loader@{Yarn.\-Loader}}
}
...
\begin{DoxyCompactItemize}
\item 
\hyperlink{a00125_a1972fc413e1679ecbe91eef536ca8479}{Loader} (\hyperlink{a00088}{Dialogue} \hyperlink{a00125_a89d1f29eba1c52c96c62a4cfe7859a1d}{dialogue})
\item 
\hyperlink{a00138}{Program} \hyperlink{a00125_a228e10256dddbcc17c231d08b3b2140b}{Load} (string text, \hyperlink{a00121}{Library} library, string file\-Name, \hyperlink{a00138}{Program} include\-Program, bool show\-Tokens, bool show\-Parse\-Tree, string only\-Consider\-Node, \hyperlink{a00048_ad7ebb46e7309ead8767383a672b3272f}{Node\-Format} format)
\end{DoxyCompactItemize}
\subsection*{Package Functions}
\begin{DoxyCompactItemize}
\item 
\hyperlink{a00131}{Node\-Info}\mbox{[}$\,$\mbox{]} \hyperlink{a00125_a0aa76ba9366b44bf78198a78ea958c9c}{Get\-Nodes\-From\-Text} (string text, \hyperlink{a00048_ad7ebb46e7309ead8767383a672b3272f}{Node\-Format} format)
\end{DoxyCompactItemize}
\subsection*{Static Package Functions}
\begin{DoxyCompactItemize}
\item 
static \hyperlink{a00048_ad7ebb46e7309ead8767383a672b3272f}{Node\-Format} \hyperlink{a00125_a080b2d6b7553c178007c04297d50e9da}{Get\-Format\-From\-File\-Name} (string file\-Name)
\end{DoxyCompactItemize}
\subsection*{Properties}
\begin{DoxyCompactItemize}
\item 
\hyperlink{a00138}{Program} \hyperlink{a00125_a6d8296076823c0c082df9024367f4860}{program}\hspace{0.3cm}{\ttfamily  \mbox{[}get, set\mbox{]}}
\end{DoxyCompactItemize}
\subsection*{Private Member Functions}
\begin{DoxyCompactItemize}
\item 
string \hyperlink{a00125_a0b09a29edd2ed13d52203f1b71a47081}{preprocessor} (string node\-Text)
\end{DoxyCompactItemize}
\subsection*{Private Attributes}
\begin{DoxyCompactItemize}
\item 
\hyperlink{a00088}{Dialogue} \hyperlink{a00125_a89d1f29eba1c52c96c62a4cfe7859a1d}{dialogue}
\end{DoxyCompactItemize}
...
\hypertarget{a00125_a1972fc413e1679ecbe91eef536ca8479}{\index{Yarn\-::\-Loader@{Yarn\-::\-Loader}!Loader@{Loader}}
...
)}}\label{a00125_a1972fc413e1679ecbe91eef536ca8479}
...
\begin{DoxyCode}
59                                          \{
60             \textcolor{keywordflow}{if} (\hyperlink{a00125_a89d1f29eba1c52c96c62a4cfe7859a1d}{dialogue} == null)
61                 \textcolor{keywordflow}{throw} \textcolor{keyword}{new} ArgumentNullException (nameof(\hyperlink{a00125_a89d1f29eba1c52c96c62a4cfe7859a1d}{dialogue}));
62 
63             this.dialogue = \hyperlink{a00125_a89d1f29eba1c52c96c62a4cfe7859a1d}{dialogue};
64 
65         \}
\end{DoxyCode}
...
\hypertarget{a00125_a080b2d6b7553c178007c04297d50e9da}{\index{Yarn\-::\-Loader@{Yarn\-::\-Loader}!Get\-Format\-From\-File\-Name@{Get\-Format\-From\-File\-Name}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [package]}}}\label{a00125_a080b2d6b7553c178007c04297d50e9da}
...
\begin{DoxyCode}
278         \{
279             \hyperlink{a00048_ad7ebb46e7309ead8767383a672b3272f}{NodeFormat} format;
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{a00125_a080b2d6b7553c178007c04297d50e9da_icgraph}
\end{center}
\end{figure}


\hypertarget{a00125_a0aa76ba9366b44bf78198a78ea958c9c}{\index{Yarn\-::\-Loader@{Yarn\-::\-Loader}!Get\-Nodes\-From\-Text@{Get\-Nodes\-From\-Text}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [package]}}}\label{a00125_a0aa76ba9366b44bf78198a78ea958c9c}
...
451         \}
\end{DoxyCode}
\hypertarget{a00125_a228e10256dddbcc17c231d08b3b2140b}{\index{Yarn\-::\-Loader@{Yarn\-::\-Loader}!Load@{Load}}
...
\item[{{\bf Node\-Format}}]{format}
\end{DoxyParamCaption}
)}}\label{a00125_a228e10256dddbcc17c231d08b3b2140b}
...
\begin{DoxyCode}
195         \{
196             \textcolor{keywordflow}{if} (format == \hyperlink{a00048_ad7ebb46e7309ead8767383a672b3272f}{NodeFormat}.Unknown)
197             \{
198                 format = \hyperlink{a00125_a080b2d6b7553c178007c04297d50e9da}{GetFormatFromFileName}(fileName);
199             \}
200 
201             \textcolor{comment}{// currently experimental node can only be used on yarn.txt yarn files and single nodes}
202             \textcolor{keywordflow}{if} (format != \hyperlink{a00048_ad7ebb46e7309ead8767383a672b3272f}{NodeFormat}.Text && format != \hyperlink{a00048_ad7ebb46e7309ead8767383a672b3272f}{NodeFormat}.SingleNodeText)
203             \{
...
207             \textcolor{keywordflow}{if} (format == \hyperlink{a00048_ad7ebb46e7309ead8767383a672b3272f}{NodeFormat}.SingleNodeText)
208             \{
...
217             \}
218 
219             \textcolor{keywordtype}{string} inputString = \hyperlink{a00125_a0b09a29edd2ed13d52203f1b71a47081}{preprocessor}(text);
...
228             parser.AddErrorListener(\hyperlink{a00096_a47b8f4f1d414afa1ea6067218c7ee34d}{ErrorListener.Instance});
229 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{a00125_a228e10256dddbcc17c231d08b3b2140b_cgraph}
\end{center}
\end{figure}


\hypertarget{a00125_a0b09a29edd2ed13d52203f1b71a47081}{\index{Yarn\-::\-Loader@{Yarn\-::\-Loader}!preprocessor@{preprocessor}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}}\label{a00125_a0b09a29edd2ed13d52203f1b71a47081}
...
\hypertarget{a00125_a89d1f29eba1c52c96c62a4cfe7859a1d}{\index{Yarn\-::\-Loader@{Yarn\-::\-Loader}!dialogue@{dialogue}}
\index{dialogue@{dialogue}!Yarn::Loader@{Yarn\-::\-Loader}}
\subsubsection[{dialogue}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Dialogue} Yarn.\-Loader.\-dialogue\hspace{0.3cm}{\ttfamily [private]}}}\label{a00125_a89d1f29eba1c52c96c62a4cfe7859a1d}
...
\hypertarget{a00125_a6d8296076823c0c082df9024367f4860}{\index{Yarn\-::\-Loader@{Yarn\-::\-Loader}!program@{program}}
\index{program@{program}!Yarn::Loader@{Yarn\-::\-Loader}}
\subsubsection[{program}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Program} Yarn.\-Loader.\-program\hspace{0.3cm}{\ttfamily [get]}, {\ttfamily [set]}}}\label{a00125_a6d8296076823c0c082df9024367f4860}
