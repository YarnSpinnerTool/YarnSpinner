namespace Yarn.Compiler
{
    ...
    internal class BodyVisitor : YarnSpinnerParserBaseVisitor<int>
    {
        ...
        public override int VisitDeclare_statement(YarnSpinnerParser.Declare_statementContext context)
        {
            ...
            var type = expressionVisitor.Visit(context.expression());

            var declaration = new VariableDeclaration {
                name = context.variable().GetText(),
                type = type,
                defaultValue = null // TODO: compute the constant Value defined in this statement and store it here
            };
        ...
        /// </summary>
        private class ExpressionTypeVisitor : YarnSpinnerParserBaseVisitor<Value.Type> {
            ...
            public override Value.Type VisitValueFunc(YarnSpinnerParser.ValueFuncContext context) {
                throw new NotImplementedException("Function type checking is not yet implemented.");
            }
            ...
            private Value.Type CheckOperation(ParserRuleContext context, ParserRuleContext[] terms, string operationType, params Value.Type[] permittedTypes ) {
                ...
                // All types must be the same (i.e. same as the first type)
                for (int i = 1; i < types.Count; i++) {
                    Value.Type type = types[i];
                    if (type != firstType) {
