...
line_formatted_text
    : ( TEXT // a chunk of text to show to the player
      ...
      | FORMAT_FUNCTION_START format_function FORMAT_FUNCTION_END // a format function
      )* 
    ;

format_function
    : function_name=FORMAT_FUNCTION_ID EXPRESSION_START variable EXPRESSION_END key_value_pair*
    ;
