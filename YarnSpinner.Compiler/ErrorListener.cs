...
namespace Yarn.Compiler
{
    ...
    public sealed class Diagnostic
    {
        ...
        /// from another Diagnostic.
        /// </summary>
        /// <param name="other">The <see cref="Diagnostic"/> to clone.</param>
        internal Diagnostic(Diagnostic other)
        {
...
#pragma warning restore CS0618
        ...
        {
            /// <summary>
            /// A diagnostic that is not reported.
            /// </summary>
            /// <remarks>
            /// Diagnostics with this severity are generated by the compiler and
            /// included in the compilation result, but are not shown to the end
            /// user.
            /// </remarks>
            None = 0,
