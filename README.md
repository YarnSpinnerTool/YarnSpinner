...
**Yarn Spinner** interprets the Yarn language, and is written in C#. Yarn Spinner is designed to be easy to add to [Unity](http://www.unity3d.com) games, but it's also intended for use in other contexts as well.
