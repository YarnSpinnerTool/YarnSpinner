...
- `Library.GenerateUniqueContentViewedVariableName()` that returns the same unique value used to generate `once` variables.
  ...
  - To reset a variable can do something like the following:
    ```
    title: Start
    ---
